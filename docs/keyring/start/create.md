...
The number for the `ss58Format` is derived from the list of [ss58-registry](https://github.com/paritytech/ss58-registry/blob/main/ss58-registry.json) list. In the above example `2 == kusama`
